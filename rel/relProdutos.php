...
<body>
	<?php if ($cabecalho_img_rel == 'Sim') { ?>
		<div class="img-cabecalho my-4">
			<img src="../img/logoPDV.png" width="100%">
		</div>
	<?php } else { ?>
		<div class="cabecalho">
			<div class="row titulos">
				<div class="col-sm-2 esquerda_float image">
					<img src="../img/logoPDV.png" width="90px">
				</div>
	...
	<main>
		<div class="container">
			<div align="center">
				<span class="titulorel">Produtos em Estoque</span>
			</div>
			<hr>
			...
			<div class="mx-2" style="padding-top: 15px">
				<small><small>
						...
						?>
							...
							<div class="cabecalho" style="border-bottom: solid 1px #e3e3e3;"></div>
			...
			<div class="row margem-superior">
				<div class="col-md-12">
					<div align="right">
						<span><b>Total de Produtos: <?php echo $totalItens ?></b></span>
					</div>
				</div>
			</div>
			<hr>
