...
if($total_reg == 0)
$pdo->query("INSERT INTO usuarios SET nome = 'Administrador', email = 'alvescosta74@gmail.com', cpf = '000.000.000-00', senha = '123', nivel = 'Administrador' ");
...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="vendor/login/images/icons/logoPDV.ico"/>
<!--===============================================================================================-->
...
<!--===============================================================================================-->
	...
	<link rel="shortcut icon" href="img/logoPDV.ico" />
		...
		<div class="container-login100" style="background-image: url('vendor/login/images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					<img src="img/novo.png" width="100">
				</span>
